package org.sake.storeadmin.domain.userorder.consumer;

import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import org.sake.common.message.model.UserOrderMessage;
import org.sake.storeadmin.domain.userorder.business.UserOrderBusiness;
...
public class UserOrderConsumer {
    ...
    @RabbitListener(queues = "sake.queue")
